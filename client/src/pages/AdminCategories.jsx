...
export default function AdminCategories() {
  ...
  const [activeTab, setActiveTab] = useState('categories') // 'categories' | 'transactions'
  ...
  return (
    <div className="content content-wide">
      <div className="page-head">
        ...
        {/* Tab navigation */}
        <div className="period-toggle admin-tabs" style={{ marginBottom: 'var(--s-4)' }}>
          <button
            type="button"
          ...
          <button
            type="button"
            className={activeTab === 'transactions' ? 'on' : ''}
